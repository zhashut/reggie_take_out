...
public class EmployeeController {
    ...
    /**
     * 员工登录
     * @RequestBody：返回一个JSON类型的数据到后台
     * HttpServletRequest：如果登录成功，把员工id存入到session里，到时候可以通过get-session获得对象
     * @return
     */
    @PostMapping("/login")
...
//        employee.setUpdateUser(empId);
    ...
    public R<String> update(HttpServletRequest request, @RequestBody Employee employee) {
        ...
        employeeService.updateById(employee);//根据id修改用户信息
